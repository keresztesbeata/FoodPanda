...
public class DeliveryZoneRestController {
    ...
    public List<DeliveryZoneDto> getDeliveryZonesOfRestaurant(@RequestParam String restaurant) {
        return deliveryZoneService.getDeliveryZonesOfRestaurant(restaurant);
    }
}
